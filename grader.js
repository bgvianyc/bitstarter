...
var URL_DEFAULT = "http://protected-savannah-5747.herokuapp.com/";
...
var buildfn = function(checks) {
        var response2console = function(result, response) {
			...
			return null;
				    ...
				    outJsonString(tmpfile,checks);
				            }
	        };
        return response2console;
    };

var outJsonString = function(htmlfile,checks) {
...
if(require.main == module){
	...
	outJsonString(program.file,program.checks);
	}
    }
else {
